...
/*
임포트 선언부
 : 현재 작성하는 클래스에서 다른 클래스를 가져다 쓰기위한 선언으로
   클래스가 생성된 패키지명과 클래스명을 함께 작성하면 된다.
   만약 해당 패키지 하위에 선언된 모든 클래스를 한꺼번에 임포트하고
   싶다면 import java.util.*와 같이 와일드카드를 사용하면 된다.
 */
import java.util.Date;

import ex09package.kosmo.area.util.CommonUtil;
...
public class E01PackageMain
{
	public static void main(String[] args)
	{
		...
		따라서 isNumber() 메소드를 호출하기 위해
		반드시 해당 패키지를 import 해야한다.
		 */
		...
		System.out.println(ex09package.kosmo.area.util.CommonUtil.isNumber("백20"));
	}
}
