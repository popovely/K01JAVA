...
public class Ex04HashSet1 {
	...
	public static void main(String[] args) {
		...
		/*
		3] 객체저장
		 : add()메소드를 통해 저장하고, 문제가 없다면 true가 반환된다.
		 */
		...
		/*
		5-1] 기본 클래스형 객체의 중복저장
			 : 기본 클래스의 경우 별도의 오버라이딩 없이 중복이 제거된다.
			   따라서 아래의 경우 저장에 실패하므로 false가 반환된다. 
		 */
		...
		5-2] 개발자가 정의한 객체 중복저장
			 : 사용자정의 클래스인 경우 hashCode(), equals()메소드를
		...
		while(itr.hasNext()) {	//추출할 객체가 있는 확인 후
