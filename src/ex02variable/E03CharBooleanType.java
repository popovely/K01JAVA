...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		/*
		아스키코드 : 1byte로 표현할수 있는 문자(영문, 숫자)를 십진수로
			정의한것을 말한다.
		...
		System.out.println("ch3(아스키코드출력)=>"+ (int)ch3);	// 67출력됨
		
		char ch4 = '1';	//싱글쿼테이션으로 감쌌으므로 문자 1이 할당됨
		char ch4_1 = '1' + 1;	// 49+1
		...
		/*
		&&(논리 And) : 엠퍼센트. 양쪽 모두 참일때만 참을 반환하는
			연산자. 그 외에는 모두 거짓을 반환한다.
		||(논리 Or) : 파이프. 둘중 하나만 참이어도 참을 반환하는 연산자.
			둘 다 거짓일때만 거짓을 반환한다.
		 */
