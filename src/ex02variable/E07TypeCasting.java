...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		byte b1 = 65;
		short s1;
		s1 = b1;	//byte 형이 short형보다 작은 자료형이므로 자동형변환 됨.
		...
		성질이 다르므로 명시적 형변환(강제형변환=casting) 후 대입해야 한다.
		 */
		//char ch1 = b1;	->에러발생.
		char ch2 = (char)b1;
		...
		/*
				서식문자 사용시 %.2f : 정수부는 모두 표현하고
					소수점 이하 2자리까지만 표현하겠다는 의미이다.
		 */
		
		/*
		char와 int를 연산하면 결과는 int형이므로 char형 변수에
		결과를 대입하려면 반드시 명시적 형변환(강제형변환=casting)을 한 후 진행해야한다.
		 */
		char ch3 = 'A', ch4;
		int num4 = 2;
		//ch4 = ch3 + num4; ->에러발생.
