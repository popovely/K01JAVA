...
class Adder {
	...
	/*
	static으로 선언된 멤버변수는 실제로는 외부(메소드영역)에 생성되어 있으므로
	클래스명을 통한 접근이 허용된다.
...
public class E03StaticInheritance {
	...
	public static void main(String[] args) {
		...
		/*
		멤버변수 val은 static 이므로 프로그램 시작시 하나만 생성되어
		메소드영역에 로드된다. 따라서 아래의 모든 연산은
		val에 모두 더해진다. 
		 */
		Adder ad = new Adder();
