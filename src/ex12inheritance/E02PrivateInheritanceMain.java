...
class Account {
	...
	/*
	입금처리가 protected로 선언되었으므로 상속관계에서 접근가능하다.
	 */
	...
	//private으로 선언된 멤버변수를 외부로 반환할때 사용한다.(getter메소드)
...
class SavingAccount extends Account {
	...
	/*
	인자생성자에서 부모의 생성자 메소드를 호출하기위한 super()를 사용한다.
	...
	public void showAccountMoney() {
		/*
		private멤버변수인 money는 자식클래스에 직접 접근할 수 없으므로
...
public class E02PrivateInheritanceMain {
	...
	public static void main(String[] args) {
		...
		접근할 수 없다.
		은닉된 정보이므로 'not visible'이라는 에러메시지가 나온다.
		 */
//		sa.money = 100000;	->에러발생. 접근불가
		sa.saveMoney(5000);
		sa.showAccountMoney();
