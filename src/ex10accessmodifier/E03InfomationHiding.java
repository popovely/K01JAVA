...
class FruitSeller6 {
	...
	private int numOfApple;	//판매자가 보유한 사과개수
...
class FruitBuyer6 {
	...
	//외부클래스에서 접근할 수 없도록 private으로 선언한다.
	private int myMoney;	//구매자가 보유한 금액
	private int numOfApple;	//구매자가 구매한 사과의 개수
...
public class E03InfomationHiding
{
	public static void main(String[] args)
	{
		...
		멤버메소드를 통해서만 구매가 이뤄질수 있도록 구현해야 한다.
		 */
		/*
		...
		buyer.numOfApple += 70;		//따라서 구매자가 가진 사과는 70개가 증가했다.
