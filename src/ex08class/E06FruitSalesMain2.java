...
두번째 버전에서는 다양한 초기값을 부여할 수 있도록 초기화메소드를
도입해본다.
 */
...
class FruitSeller2 {
	...
	/*
		기존 상수에서 일반 변수 'apple_price'로 변경한다.
		클래스의 멤버상수로 정의하는 경우 선언과 동시에 초기화해야 하므로
	...
	멤버메소드에서는 초기화 할수 없다. 멤버메소드는 개발자가 원할때 언제든지
...
public class E06FruitSalesMain2
{
	...
	{
		/*
		초기화 메소드가 정의되었으므로 상태가 다른 객체를 생성할 수 있다.
		 */
