...
생성자(Constructor)
	...
	- 반환값이 없다. ;특정 연산 후 값을 반환할 수 없다.
	  따라서 반환타입을 지정하면 에러가 발생한다.
...
public class PersonConstructor
{
	...
	public PersonConstructor(String name, int age) {
		...
		단, 생성자내에서만 사용할 수 있고, 일반 멤버메소드에서는
		사용할 수 없다.
		 */
		this(name, age, "미상");
...
//		this(name, age, "미상");	->에러발생.
		...
		//멤버변수 구분을 위한 this는 멤버메소드에서도 사용가능
		this.name = name;
		this.age = age;
		this.addr = addr;
	}
