...
//	
//	//놀이를 통해 구슬을 획득 또는 상실하는 것을 표현한다.
//	public void obtainBead(ChildProperty loser, int num) {
//		this.marble += num;
//		loser.marble -= num;
//	}
//}	
...
class ChildProperty{
	...
	/*
	해당 멤버메소드의 호출의 주체가 되는 객체가 beadCnt만큼 구슬을 획득하고
	매개변수로 전달되는 child객체는 beadCnt만큼 구슬을 잃게된다.
	 */
	void obtainBead(ChildProperty child, int beadCnt) {
		this.bead += beadCnt;
		child.bead -= beadCnt;
		System.out.println("==스테이지 종료==");
	}
}
