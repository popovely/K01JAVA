...
//		System.out.println(Integer.parseInt(floatString));	->예외발생
		...
		/*
		codePointAt()
		 : 문자열에서 index에 해당하는 한 문자의 아스키코드 값을 반환한다.
		 */
		 ...
		 */
		System.out.println("isLetter()를 통한 숫자판단");
		...
		/*
		[시나리오]
		주어진 문자열 안에 몇개의 공백문자(스페이스)가 있는지
		판단하는 프로그램을 작성하시오.
		 ...
		 */
		String whiteString = " H E L L O	P O P O ♥ ";
		int whiteCount = 0;
