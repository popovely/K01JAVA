...
public class E05DateCalendar1 {
	...
	/*
	특정 날짜를 지정하여 남은 날짜를 계산해서 반환하는 메소드.
	...
	public static String[] myDiffDate() throws ParseException {
		...
		1~10자리까지는 순수한 초이고, 11~13자리는 밀리세컨즈를 표현한다.
	...
	public static void main(String[] args) throws ParseException {
		...
		getInstance()메소드를 사용하면 싱글톤이라고 생각하면 된다.
		 */
		...
		//내일날짜 : add()메소드를 사용하여 오늘 날짜에 1을 더한다. 
		Calendar calendar2 = Calendar.getInstance();
		calendar2.add(Calendar.DATE, 1);
		//myDateFormat()을 호출하면 아래 코드의 중복을 제거할 수 있다. ;간결하게 만들 수 있다.
		date = calendar2.getTime();
		String dateStr5 = new SimpleDateFormat("yyyy-MM-dd").format(date);
		System.out.println("내일날짜:"+ dateStr5);
		
		//'월'을 정의한 상수 : 1을 더해야 원하는 월을 표현할 수 있다.
