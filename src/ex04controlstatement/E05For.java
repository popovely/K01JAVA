...
public class E05For {
	...
	public static void main(String[] args) {
		...
		구하는 프로그램을 작성하시오.
		 */
		//방법1 : 10번 반복에서 if문을 통해 2의배수를 찾은 후 누적합을 구한다.
		int total = 0; 
		for(int i=1; i<=10; i++) {
			if(i%2==0) {
				total += i;
		...
		//방법2 : if문 없이 2씩 증가하면서 누적합을 구한다.
		total = 0;
		for(int i=0; i <=10; i+=2) {	//복합대입연산자 사용가능함.
			total += i;
		}
...
//		int a = 1;
//		for(;;) {
//			System.out.println("나는 for문으로 만든 무한루프임당."+ a);
//			a++;
//		}
...
//		for(int j=0; j<=5; j++);
//		{
//			System.out.println("어라링.. 나는 누구?여긴 어디냥?");
//		}
...
//		System.out.println("위 for문에서 선언한 변수 j="+ j);
		...
		for(int dan=2; dan<=9; dan++) {
			for(int su=1; su<=9; su++) {
				result = dan * su;
				System.out.printf("%2d*%2d=%2d", dan, su, result);
			}
			System.out.println();
		}
