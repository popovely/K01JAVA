...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		[시나리오]
		1부터 1000까지의 정수중 4의배수이거나 7의배수인 수의 합을 구하여
		출력하는 프로그램을 작성하시오.
...
//				System.out.println("j="+ j);
		...
		/*
		[시나리오]
		국어, 영어, 수학 점수를 사용자로부터 입력받은 후
		평균을 구해 A~F학점을 판단하여 출력하는 프로그램을 작성하시오.
		단, 사용자가 X,x(대소문자 구분없음)를 입력하면 프로그램이 종료되어야 하며
		do~while문으로 구현해야 한다.
		 */
		//사용자로부터 키보드를 통해 입력값을 받기 위한 Scanner클래스 사용
		Scanner scanner = new Scanner(System.in);
		//국,영,수,평균 점수를 입력하기 위한 변수선언
		...
		do {
			...
			switch문은 조건식을 쓸수 없고 산술식만 쓸 수 있기때문에
