...
//			//answer배열의 i번째 인덱스 요소가 만약 1이면
//			//counter배열의 i번째 요소를 1증가시킨다.
//			if(answer[i]==1) counter[0]++;	//증가연산자 사용
//			if(answer[i]==2) counter[1] += 1;	//복합대입연산자 사용
//			if(answer[i]==3) counter[2] = counter[2] + 1;	//산술연산자 사용
//			if(answer[i]==4) counter[3] = counter[3] + 1;	//산술연산자 사용
//		}
//		
//		//counter배열 출력
//		for(int i=0; i<counter.length; i++) {
//			//0번째 요소에는 1의 개수가 입력되어있다.
//			System.out.printf("counter[%d] %d의개수:%d\n", i, i+1, counter[i]);
//		}
//	}
}
