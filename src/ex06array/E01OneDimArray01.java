...
public class E01OneDimArray01
{
	...
	public static void main(String[] args)
	{
		...
		자바 컴파일러가 초기값의 개수를 통해 크기를 결정할 수 있다.
		따라서 이런경우에는 크기는 생략하도록 약속되어있다.
		 */
...
//		int[] initArr2 = new int[3] {1, 20, 300}; ->에러발생
		...
		/*
		배열 요소의 개수를 통해 배열을 생성한 후 초기화까지 동시에 진행한다.
		이 경우 new 생략가능
		 */
		System.out.println("방법3: 초기값만으로 선언");
		//요소의 개수를 통해 크기가 5로 지정됨
		int[] initArr3 = {11, 13, 17, 19, 23};
		int arrSum = 0;
		//요소의 개수만큼 루프되면서 각 요소를 누적해서 더함
