...
public class E01OneDimArray02
{
	...
	public static void main(String[] args)
	{
		...
		난수 생성방법2
			: Random 클래스를 사용한다.
			사용법은 Scanner와 동일하게 nextInt()메소드를 이용하면
			정수형 난수를 생성할 수 있다.
		 */
		...
		/*
		로또번호 1~45사이의 난수를 생성하는 방법
			1. 0.xxxx형태로 난수를 생성한 후 정수로 변경하기 휘애
				100을 곱한 후 정수로 변환한다. (소수 이하 절삭)
			2. 45로 %연산하여 나머지를 구한다.
				모든 정수는 45로 나누었을때 나머지가 0~44까지 나온다.
			3. 0은 구간에 포함되지 않으므로 2번의 결과에 1을 더한다.
				결과적으로 1~45사이의 정수형 난수를 생성할 수 있다.
		 */
